...
export class AutocompleteStyles {
  ...
  public static getStyleInnerHTML() {
    return ".cancel-icon { transform:scale(1); z-index:10008; width: 25px; height: 25px; } .cancel-icon button { background-color: royalblue; opacity: 0.5; color: white; font-family: Verdana, Geneva, Tahoma, sans-serif; font-size: 12px; width: inherit; height: inherit; text-align: center; border: none; }\r\n"
      + ".autocomplete-popup { transform:scale(1); z-index:10007; background-color: #ffffff; max-width:100%; opacity: 1; }\r\n"
      + ".autocomplete-wrapper { border: 1px solid #dedede; }\r\n"
...
/**
 * Extends AutocompleteStyles to maintain backwards-compatibility with version 1.0 which had an incorrectly named selector.
 * @class AutocompleteStylesBackCompat
 */
@Directive({
  selector: '[autocomplete-styles]'
})
export class AutocompleteStylesBackCompat extends AutocompleteStyles {
  constructor(ref: ElementRef) {
    super(ref);
  }
}